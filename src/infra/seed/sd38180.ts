...
export async function seedSD38180IfFirstRun(deps: SeedDeps): Promise<boolean> {
  ...
  const events: Array<{ at: string; type: any; desc: string; tags?: string[] }> = [
  ...
  const flags = [
    ...
    {
      type: 'reasonable_efforts' as const,
      severity: 'watch' as const,
    ...
    {
      type: 'chemical_dependency' as const,
      severity: 'watch' as const,
